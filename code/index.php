...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="Booking Form.php"><h2>ROOM RESERVATION</h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HOSHI HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>$</span>320</h3>						
								<a href="Booking Form.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>Feedback Us</h4>
				<p class="contact-agile2">For Us To Make It Better</p>
				...
				if(isset($_POST['sub']))
				{
					...
					$sql = "INSERT INTO `feedback`(`name`,`email`,`message`,`fdate`,`c_id`) VALUES ('$name','$email','$message',now(),(select c_id from customer where email = '$email'))" ;
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+94 (65)999-99-99</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HOSHIHOTEL.COM</a></p>
